...
sfs_io_nolock(struct sfs_fs *sfs, struct sfs_inode *sin, void *buf, off_t offset, size_t *alenp, bool write) {
  ...
  //LAB8:EXERCISE1 2013011349 HINT: call sfs_bmap_load_nolock, sfs_rbuf, sfs_rblock,etc. read different kind of blocks in file
	/*
	...
	*/
    int start,end,len;
    if((start=offset%SFS_BLKSIZE)!=0){
    	len=(nblks?SFS_BLKSIZE-start:endpos-offset);
